...
module.exports = {
    init: function(channel, user, msg) {
        var hm = msg.split(" ")
        if (hm[1]=="help") {
            channel.send("..trees list: List all trees placed\n\n..trees harvest: Harvest all ready trees")
        } else {
                        ...
                        if (fs.existsSync("./skyfiles/" + iselect + ".json")) {
                            ...
                            if (hm[1]=="list") {
                                ...
                                if (mytrees.length==0) {
                                    ...
                                    if (newtrees.length!=mytrees.length) {
                                      channel.send("Trees harvested!")
                                    } else {
                                      channel.send("No trees were harvested!")
                                    }
                                }
                            }
                        } else {
