...
var funcs = {
  ...
  levelup: require("./levelup.js"),
  levelcheck: require("./levelcheck.js"),
  spawners: require("./spawners.js")
}
...
client.on("message", (msg) => {
  ...
  if (msgcontent.startsWith("..seeme")) {
    ...
    funcs.skyblock.init(msg.channel, msg.author, msg.content, msg)
  }
  ...
  else if (msg.content.startsWith("..levelup")) {
    funcs.levelup.init(msg.channel, msg.author, msg.content)
  }
  else if (msg.content.startsWith("..levelcheck")) {
    funcs.levelcheck.init(msg.channel, msg.author, msg.content)
  }
  else if (msg.content.startsWith("..spawners")) {
    funcs.spawners.init(msg.channel, msg.author, msg.content)
  }
})
